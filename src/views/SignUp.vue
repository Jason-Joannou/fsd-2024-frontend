      ...
      <el-row type="flex" justify="center" align="middle" class="form-row">
        <el-col :span="8">
          <el-card class="box-card">
            ...
            <el-form ref="form" :model="form" label-width="120px" class="sign-up-form">
              ...
              <el-form-item label="Username" class="form-item">
                <el-input v-model="form.username" placeholder="Choose a username"></el-input>
              </el-form-item>
              <el-form-item label="Password" class="form-item">
                <el-input type="password" v-model="form.password" placeholder="Create a password"></el-input>
              </el-form-item>
              <el-form-item>
                <el-button type="primary" @click="onSubmit" class="sign-up-button">Sign Up</el-button>
              </el-form-item>
              <el-alert
                v-if="errorMessage"
                type="error"
